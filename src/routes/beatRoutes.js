...
/**
 * @swagger
 * /api/v1/beats/{id}/promote:
 *   patch:
 *     tags:
 *       - Beats
 *     summary: Toggle beat promotion
 *     description: Toggles the promoted status of a beat. When promoting, validates that the user has the promotedBeat add-on feature. Promoted beats appear first in explore/search results.
 *     security:
 *       - gatewayAuth: []
 *         userId: []
 *     parameters:
 ...
 *                 message:
 *                   type: string
 *                   example: "Beat promoted successfully"
 *                 data:
 *                   type: object
 *                   properties:
 *                     beatId:
 ...
 *         description: No autenticado
 *       403:
 *         description: No tiene permisos o la feature no está disponible
 *       404:
 *         description: Beat no encontrado
 */
router.patch(
  ...
  requireAuth,
  requireOwnership,
  BeatController.togglePromotion
);
